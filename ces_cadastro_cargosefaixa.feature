...
#------------------------------------------------------------------------------------------------------------------------
@teste
  Cenário: Cadastro de Faixa Salarial Por Índice - Data Anterior ao primeiro histórico
      Dado que exista o cargo "Desenvolvedor Java"
      Dado que exista um indice "Desenvolvedor Salario" com historico na data "01/01/2000" e valor "1500"
      Dado que exista um historico na data "01/01/2017" e valor "3000" no indice "Desenvolvedor Salario"
      Dado que eu esteja logado com o usuário "SOS"
    Quando eu acesso o menu "C&S > Cadastros > Cargos e Faixas"
     Então eu clico na linha "Desenvolvedor Java" da imagem "Faixas Salariais" 
         E eu clico no botão "Inserir"
         E eu preencho "Faixa" com "1 A"
         E eu preencho o campo (JS) "A partir de" com "01/01/1999"
         E eu seleciono "Desenvolvedor Salario" de "Índice"
